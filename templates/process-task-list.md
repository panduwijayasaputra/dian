...
- **Completion protocol:**
  ...
  - **First**: Run the full test suite (`pytest`, `npm test`, `pnpm test`, `bin/rails test`, etc.)
...
2. Do not create any sample or non-functional files that are not directly related to the tasks
